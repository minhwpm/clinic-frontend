...
const LocaleSwitch = ({ pageContext }) => {
  ...
  return (
    <div ref={select} className="relative ml-4 ">
      <button
        type="button"
        className="hover:bg-primary-base-50 hover:text-primary-base focus:bg-primary-base-50 focus:text-primary-base focus:outline-none flex items-center justify-between px-2 py-2 cursor-pointer h-full rounded-md w-20"
        onClick={() => setShowing(!showing)}
      >
        <WorldIcon />
        <span className="capitalize">{locale}</span>
        <MdExpandMore className="ml-1 text-primary-base" />
      </button>
      <div
            ...
            return (
              ...
              >
                <p
                  ...
                  className="capitalize hover:bg-primary-base-50 hover:text-primary-base  cursor-pointer p-2 rounded-md text-center hover:text-primary-base"
                >
                  {locale}
                </p>
              </Link>
